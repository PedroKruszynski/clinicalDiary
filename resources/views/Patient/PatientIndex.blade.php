...
<div class="container">
    ...
    <div class="row">
        <div class="offset-10 col-12">
            <a href="{{ route('patient.createAndAlterView') }}">
                <img class="img-fluid"
                    ...
                    @if(isset($patients))
                        @foreach ($patients as $patient)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('patient.createAndAlterView', $patient->id) }}"
                                          id="editForm{{$patient->id}}"
                                          method="GET">
                                      @CSRF
                                      <a type="submit" role="button" onclick="$('#editForm{{$patient->id }}').submit()">
                                ...
                                <td>
                                    <form action="{{ route('patient.delete', $patient->id) }}"
                                        ...
                                        @CSRF
                                        @METHOD('DELETE')
                                        <a type="submit" role="button" onclick="$('#deleteForm{{$patient->id }}').submit()">

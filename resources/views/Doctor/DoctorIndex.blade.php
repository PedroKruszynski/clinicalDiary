...
<div class="container">
    ...
    <div class="row">
        <div class="offset-10 col-12">
            <a href="{{ route('doctor.createAndAlterView') }}">
                <img class="img-fluid"
                     title="Criar Médico"
                     id="img-plus"
                    ...
                    @if(isset($doctors))
                        @foreach ($doctors as $doctor)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('doctor.createAndAlterView', $doctor->id) }}"
                                          id="editForm{{$doctor->id}}"
                                          method="GET">
                                      @CSRF
                                      <a type="submit" role="button" onclick="$('#editForm{{$doctor->id }}').submit()">
                                ...
                                <td>
                                    <form action="{{ route('doctor.delete', $doctor->id) }}"
                                        ...
                                        @CSRF
                                        @METHOD('DELETE')
                                        <a type="submit" role="button" onclick="$('#deleteForm{{$doctor->id }}').submit()">
